...
const TransactionSchema = new mongoose.Schema({
  ...
  transactions: [{ text: {type:String,required:[true,"Please enter the name "]}, amount: {type:Number, required:[true,'Please enter a positive or negative number']} ,createdAt:{
    type:Date,
    default:Date.now
  }}],
  tokens:[{
